...
# Install Open-Zwave 
RUN cd /tmp && \
    wget "https://github.com/ekarak/openzwave-debs-raspbian/raw/master/v1.4.79/libopenzwave-doc_1.4.79.gfaea7dd_all.deb" && \
    ...
    wger "https://github.com/ekarak/openzwave-debs-raspbian/raw/master/v1.4.79/openzwave_1.4.79.gfaea7dd_armhf.deb" && \ 
